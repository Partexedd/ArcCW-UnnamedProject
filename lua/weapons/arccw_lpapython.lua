...
SWEP.ActivePos = Vector(-0.5, 0, 0.7)
...
SWEP.Animations = {
    ...
    ["2_to_1"] = {
        Source = "decock",
        SoundTable = {
            { s = pathCSR .. "boltforward.ogg", t = 0.1 }
        },
    },
    ...
    ["fire_dry_sact"] = {
        Source = "dry_fire_cocked",
        MinProgress = 0.95,
        SoundTable = {
            { s = path .. "revolver_cock.ogg", t = 0.35 }
        },
    },
    ...
    ["enter_inspect_cocked"] = {
        Source = "enter_inspect_cocked",
        time = 10 / 30,
        Framerate = 30,
        LHIK = true,
        LHIKIn = 0.2,
...
SWEP.Attachments = {
    {
        ...
        Slot = {"lowpoly_python_grip"},
        FreeSlot = true,
    },
    {
        PrintName = "Frame Skin",
        DefaultAttName = "Black Frame",
        Slot = {"lowpoly_python_frame"},
        FreeSlot = true,
    },
}