...
SWEP.ViewModel = "models/weapons/arccw/c_lpamp5.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpamp5.mdl"
...
SWEP.ActivePos = Vector(0.34, 0.2, 0.1)
...
SWEP.Attachments = {
    ...
    { 
        PrintName = "Kit",
        Slot = {"lowpoly_mp5_kit"},
    },
    { 
        PrintName = "Stock",
        DefaultAttName = "Telescopic Stock",
        Slot = {"lowpoly_mp5_stock"},
    },
}