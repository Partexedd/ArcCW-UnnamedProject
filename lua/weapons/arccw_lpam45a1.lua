...
SWEP.ViewModel = "models/weapons/arccw/c_lpam45a1.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpam45a1.mdl"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Frame",
        DefaultAttName = "Black M45A1",
        Slot = {"lowpoly_m45a1_frame"},
        FreeSlot = true,
    },
}