...
SWEP.ViewModel = "models/weapons/arccw/c_lpausp.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpausp.mdl"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        LHIKOut = 0.6,
        SoundTable = {
            { s = pathGSH .. "sliderelease.ogg", t = 6 / 30, c = ca, v = 0.8 },
        },
    },
    ["draw"] = {
        Source = "draw",
    ...
    ["fire"] = {
        ...
        Time = 15 / 30,
        ShellEjectAt = 0.02,
        SoundTable = {{ s = {pathGSH .. "mech-01.ogg", pathGSH .. "mech-02.ogg", pathGSH .. "mech-03.ogg", pathGSH .. "mech-04.ogg", pathGSH .. "mech-05.ogg", pathGSH .. "mech-06.ogg"}, t = 0.03 }},
    },
    ["fire_empty"] = {
        Source = "fire_empty_9",
        Framerate = 30,
        Time = 15 / 30,
        ShellEjectAt = 0.02,
        SoundTable = {{ s = pathGSH .. "empty.ogg", t = 0.02 }},
    },
    ...
    ["reload"] = {
        ...
        MinProgress = 0.8,
        SoundTable = {
            { s = pathGSH .. "magout.ogg", t = 4 / 30, c = ca, v = 1 },
            { s = pathGSH .. "drop.ogg", t = 13 / 30, c = ca, v = 1 },
            { s = pathGSH .. "magin.ogg", t = 14 / 30, c = ca, v = 1 },
    ...
    ["reload_empty"] = {
        ...
        SoundTable = {
            ...
            { s = pathGSH .. "drop.ogg", t = 13 / 30, c = ca, v = 1 },
            { s = pathGSH .. "magin.ogg", t = 14 / 30, c = ca, v = 1 },
            { s = pathGSH .. "sliderelease.ogg", t = 24 / 30, c = ca, v = 0.8 },      
