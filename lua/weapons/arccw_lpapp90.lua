...
SWEP.ViewModel = "models/weapons/arccw/c_lpapp90.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpapp90.mdl"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        LHIKOut = 0.6,
        SoundTable = {
            { s = path .. "sterling_boltunlock.ogg", t = 14 / 30, c = ca, v = 0.8 },
            { s = path .. "sterling_boltback.ogg", t = 15 / 30, c = ca, v = 0.8 },
            { s = path .. "sterling_stockopen_01.ogg", t = 30 / 30, c = ca, v = 0.8 },
        },
    },
    ["draw"] = {
        Source = "draw",
    ...
    ["reload"] = {
        ...
        SoundTable = {
            ...
            { s = path .. "sterling_magoutv2.ogg", t = 10 / 30, c = ca, v = 0.5 },
            { s = path .. "drop.ogg", t = 22 / 30, c = ca, v = 1 },
            { s = path .. "sterling_maginv2.ogg", t = 27 / 30, c = ca, v = 0.5 },
    ...
    ["reload_empty"] = {
        ...
        SoundTable = {
            ...
            { s = path .. "drop.ogg", t = 22 / 30, c = ca, v = 1 },
            { s = path .. "sterling_maginv2.ogg", t = 27 / 30, c = ca, v = 0.5 },
            { s = path .. "sterling_boltback.ogg", t = 57 / 30, c = ca, v = 0.8 },
            { s = path .. "sterling_boltlock.ogg", t = 58 / 30, c = ca, v = 0.8 },            
            --{ s = path .. "end.ogg", t = 20 / 30, c = ca, v = 0.8 },
        },
    },
