...
SWEP.ViewModel = "models/weapons/arccw/c_lpacar15.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpacar15.mdl"
...
SWEP.BodyDamageMults = 
{
    ...
    [HITGROUP_LEFTLEG] = 1.32,
    [HITGROUP_RIGHTLEG] = 1.32,
}
...
SWEP.CrouchPos = Vector(-0.5, -1, -0.2)
...
SWEP.Animations = {
    ...
    ["reload_empty_30"] = {
        ...
        SoundTable = {
            ...
            { s = path .. "magdrop.ogg", t = 16 / 30, c = ca, v = 1 },
            { s = path .. "magin.ogg", t = 17 / 30, c = ca, v = 0.8 },
            { s = path .. "charge.ogg", t = 28 / 30, c = ca, v = 0.8 },
            { s = path .. "end.ogg", t = 39 / 30, c = ca, v = 0.8 },
        },
    },
...
SWEP.Attachments = {
    {
        ...
        Bone = "Body",
        Offset = {
            vpos = Vector(0.07, -2, 3),
            vang = Angle(90, 0, -90),
        },
        InstalledEles = {"sightRail"},
        ExcludeFlags = {"blockoptic"},
        HideIfBlocked = true,
    },
    {
        PrintName = "Muzzle",
    ...
    {
        PrintName = "Kit",
        Slot = {"lowpoly_car15_kit"},
        DefaultAttName = "CAR-15",
        Bone = "Body",
        Offset = {
            vpos = Vector(0.07, -2, 3),
            vang = Angle(90, 0, -90),
    ...
    {
        PrintName = "Magazine",
        Slot = {"lowpoly_car15_mag"},
        DefaultAttName = "STANAG 20-round magazine",
    },
}