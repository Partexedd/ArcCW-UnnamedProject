...
SWEP.ViewModel = "models/weapons/arccw/c_lpakacpdw.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpakacpdw.mdl"
...
SWEP.MuzzleVelocity = 739
SWEP.PhysBulletMuzzleVelocity = 739
...
SWEP.HolsterPos = Vector(1, -4.7, -6)
SWEP.HolsterAng = Angle(35, 0, -4)

SWEP.CrouchPos = Vector(-1.2, -1, 0)
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
            ...
            { s = path .. "magin_metal.ogg", t = 17 / 30, c = ca, v = 0.8 },
    ...
    ["reload_empty"] = {
        ...
        SoundTable = {
            ...
            { s = path .. "magdrop_metal.ogg", t = 11 / 30, c = ca, v = 1 },
            { s = path .. "magin_metal.ogg", t = 17 / 30, c = ca, v = 0.8 },
            { s = path .. "chamber.ogg", t = 30 / 30, c = ca, v = 0.8 },
            { s = path .. "end.ogg", t = 35 / 30, c = ca, v = 0.8 },
        },
    },
