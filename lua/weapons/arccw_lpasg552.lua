...
SWEP.ViewModel = "models/weapons/arccw/c_lpasg552.mdl"
SWEP.WorldModel = "models/weapons/arccw/c_lpasg552.mdl"
...
SWEP.PhysBulletMuzzleVelocity = 725
...
SWEP.BodyDamageMults = 
{
    ...
    [HITGROUP_LEFTARM] = 1.7,
    [HITGROUP_RIGHTARM] = 1.7,
...
SWEP.Recoil = 0.6
SWEP.RecoilDirection = Angle(1, -0.15, 0)
