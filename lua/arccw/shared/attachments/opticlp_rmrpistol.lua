...
att.AutoStats = true
att.Slot = "lowpoly_optic_pistol"

att.Model = "models/weapons/arccw/atts/rmrpistol.mdl"

att.AdditionalSights = {
    {
        Pos = Vector(-0.025, 15, -0.82),
        Ang = Angle(0, 0, 0),
        Magnification = 1,
        ViewModelFOV = 50,
...
att.HolosightPiece = "models/weapons/arccw/atts/rmrpistol_hsp.mdl"
