...
att.Model = "models/weapons/arccw/atts/xps0.mdl"
...
att.Holosight = true
att.HolosightReticle = Material("hud/reticles/eotech.png", "mips smooth")
att.HolosightPiece = "models/weapons/arccw/atts/xps0_hsp.mdl"
